...
public class JdbcHelper {
	...
	private static CallableStatement callableStatement = null;
	    ...
	    public static ResultSet  query(String sql) throws SQLException {
	        ResultSet rs = null;
	        try {
	            getPreparedStatement(sql);//执行sql语句
	    ...
	    public static List query(String sql, Object... paramters)
	        ...
	        try {
	            ...
	            for (int i = 0; i < paramters.length; i++) {
	                preparedStatement.setObject(i + 1, paramters[i]);//给JDBC的SQL语句的占位符赋值
	            }
	     ...
	     * @throws Exception
	     */
	    public static Object insertWithReturnPrimeKey(String sql)//object是所有类的父类 返回值支持所有类型
	            throws SQLException {
	        ResultSet rs = null;
	        Object result = null;
	        try {
